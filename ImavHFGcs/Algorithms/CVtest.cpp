...
void CVtest::BmpToGrayRaw(unsigned char* input, int width, int height, unsigned char* output)
{
	int j = width * height;
	int stride = width * 3;
...
unsigned char* CVtest::Tester(unsigned char* img, int width, int height)
{
